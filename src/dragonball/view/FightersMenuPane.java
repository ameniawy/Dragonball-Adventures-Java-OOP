...
public class FightersMenuPane extends StackPane {
	...
	public FightersMenuPane(GUI gui) {
		// default fighter
		...
		playerText.setFont(Font.font("Cambria Math", FontWeight.BOLD, FontPosture.REGULAR, 30));
		playerText.setTextFill(Color.rgb(227, 0, 9));
		pN.setAlignment(Pos.CENTER);
		pN.getChildren().addAll(playerText, this.playerName);
		top.getChildren().add(pN);
